...
namespace XRC.Assignments.Project.G09
{
    public class TriggerState : MonoBehaviour
    {
        ...
        [SerializeField] private Renderer leftTriggerRenderer; // Renderer of the left trigger

        [SerializeField] private Renderer rightTriggerRenderer; // Renderer of the left trigger


        [SerializeField] private Color pressedColor = Color.green; // Color when trigger is pressed
