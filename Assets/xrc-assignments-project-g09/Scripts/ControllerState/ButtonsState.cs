...
namespace XRC.Assignments.Project.G09
{
    public class ButtonsState : MonoBehaviour
    {
        ...
        [SerializeField] private InputActionProperty m_LeftButtonAAction;

        [SerializeField] private InputActionProperty m_LeftButtonBAction;

        [SerializeField] private InputActionProperty m_RightButtonAAction;

        [SerializeField] private InputActionProperty m_RightButtonBAction;

        [SerializeField] private InputActionProperty m_leftHomeButtonAction;

        [SerializeField] private InputActionProperty m_rightHomeButtonAction;
        ...
        [SerializeField] private Transform leftButtonATransform;

        [SerializeField] private Transform leftButtonBTransform;

        [SerializeField] private Transform rightButtonATransform;

        [SerializeField] private Transform rightButtonBTransform;

        [SerializeField] private Transform leftHomeButtonTransform;

        [SerializeField] private Transform rightHomeButtonTransform;

        [SerializeField] private Transform leftThumbstickTransform;

        [SerializeField] private Color deleteFeedbackColor = Color.red;

        [SerializeField] private Color menuFeedbackColor = Color.blue;

        [SerializeField] private Color drawFeedbackColor = Color.magenta;

        [SerializeField] private Color colorPlateFeedbackColor = Color.cyan;

        [SerializeField] private Color homeFeedbackColor = Color.black;
        ...
        private void Start()
        {
            ...
            m_LeftButtonAAction.action.performed +=
                context => OnButtonPerformed(leftButtonATransform, drawFeedbackColor);
            ...
            m_LeftButtonBAction.action.performed +=
                context => OnButtonPerformed(leftButtonBTransform, menuFeedbackColor);
