...
{
    [SerializeField]
    private InputActionProperty m_LeftGripAction;

    [SerializeField]
    private InputActionProperty m_RightGripAction;

    [SerializeField]
    private Renderer leftBumperRenderer; // Renderer of the left bumper
    
    [SerializeField]
    private Renderer rightBumperRenderer; // Renderer of the left bumper


    [SerializeField]
    private Color pressedColor = Color.red; // Color when bumper is pressed
