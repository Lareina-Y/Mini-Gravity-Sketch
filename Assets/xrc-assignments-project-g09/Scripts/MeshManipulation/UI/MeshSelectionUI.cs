...
namespace MeshManipulation.UI
{
    public class MeshSelectionUI : MonoBehaviour
    {
        ...
        [SerializeField] private Color menuBackgroundColor = new Color(1f, 1f, 1f, 0.8f);
        ...
        private void TransitionButtonColor(Image buttonImage, Color targetColor, int buttonIndex)
        {
            ...
            colorTransitionCoroutines[buttonIndex] = StartCoroutine(AlphaTransitionCoroutine(buttonImage, targetColor));
        }
