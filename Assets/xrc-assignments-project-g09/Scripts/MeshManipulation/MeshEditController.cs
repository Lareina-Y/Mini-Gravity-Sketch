...
namespace XRC.Assignments.Project.G09
{
    ...
    namespace MeshManipulation
    {
        public class MeshEditController : MonoBehaviour
        {
            ...
            private GameObject vertexVisualizerPrefab;
            ...
            private void InitializeVertexGroups()
            {
                ...
                for (int i = 0; i < vertices.Length; i++)
                {
                    ...
                    if (group == null)
                    {
                        ...
                        positionTracker.OnPositionChanged +=
                            (newPosition) => UpdateVertexPosition(visualizer, newPosition);
            ...
            public void ExitEditMode()
            {
                ...
                if (meshCollider != null)
                {
                    ...
                    if (TryGetComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable>(
                            out var grabInteractable))
                    {
