...
namespace XRC.Assignments.Project.G09
{
    ...
    public class ScaleLogic : MonoBehaviour
    {
        ...
        private void UpdateAxesPosition()
        {
            ...
            Vector3 xExtentWorld = m_TargetObject.transform.TransformVector(Vector3.right * objectBounds.extents.x) +
                                   m_TargetObject.transform.right * 0.05f;
            Vector3 yExtentWorld = m_TargetObject.transform.TransformVector(Vector3.up * objectBounds.extents.y) +
                                   m_TargetObject.transform.up * 0.05f;
            Vector3 zExtentWorld = m_TargetObject.transform.TransformVector(Vector3.forward * objectBounds.extents.z) +
                                   m_TargetObject.transform.forward * 0.05f;
