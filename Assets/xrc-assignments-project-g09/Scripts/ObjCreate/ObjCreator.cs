    ...
    public class ObjCreator : MonoBehaviour
    {
        ...
        private void StartCreatingObject()
        {
            ...
            float initialDistance =
                Vector3.Distance(leftControllerTransform.position, rightControllerTransform.position);
        ...
        private void UpdateObjectScale()
        {
            if (previewObject != null)
            {
                ...
                previewObject.transform.position = Vector3.Lerp(leftControllerTransform.position,
                    rightControllerTransform.position, 0.5f);
